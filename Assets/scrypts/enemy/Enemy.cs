...
public class Enemy : MonoBehaviour
{
    ...
    [Header("Души")]
    public int soulsOnDeath = 100;      // сколько душ даёт этот враг
    public int soulsVariance = 25;      // разброс ± (итого: 75–125 при дефолте)
    ...
    void DropSouls()
    {
        ...
        // Случайный разброс душ
        int souls = soulsOnDeath + Random.Range(-soulsVariance, soulsVariance + 1);
        souls = Mathf.Max(1, souls); // минимум 1 душа

        SoulManager.Instance.AddSouls(souls);
        Debug.Log($"✨ Враг дал {souls} душ");
    }
}